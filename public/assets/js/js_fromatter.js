...
if (cards(), "undefined" != typeof Chart) {
	Chart.defaults.color = "#555555", Chart.defaults.font.family = "'Nunito Sans', sans-serif";
	...
	e.id = "lineWithShadow", e.defaults = {
	...
	a.id = "pieWithShadow", a.defaults = {
		datasetElementType: "lineWithShadowElement"
	}, Chart.register(a);
	class r extends Chart.controllers.doughnut {}
	r.id = "doughnutWithShadow", r.defaults = {
		datasetElementType: "lineWithShadowElement"
	}, Chart.register(r);
	class i extends Chart.controllers.radar {}
	i.id = "radarWithShadow", i.defaults = {
		datasetElementType: "lineWithShadowElement"
	}, Chart.register(i);
	class n extends Chart.controllers.polarArea {}
	n.id = "polarAreaWithShadow", n.defaults = {
		datasetElementType: "lineWithShadowElement"
	}, Chart.register(n);
	class s extends Chart.controllers.line {
		draw(t) {
			...
			if (Chart.controllers.line.prototype.draw.call(this, t), this.chart.tooltip._active && this.chart.tooltip._active.length) {
				...
				e.save(), e.beginPath(), e.moveTo(t, o), e.lineTo(t, a), e.lineWidth = 1, e.strokeStyle = "rgba(0, 0, 0, 0.1)", e.stroke(), e.restore()
			}
		}
	}
	...
	d.id = "lineWithAnnotationAndShadow", d.defaults = {
		datasetElementType: "lineWithShadowElement"
	}, Chart.register(d)
}
const collapse = () => {
...
if (darkMode(), "undefined" != typeof Chart) {
	...
	if (o = document.getElementById("visitorsChart"), o) {
		...
		a.addColorStop(0, "rgba(" + t.primary + ", .5)"), a.addColorStop(.75, "rgba(" + t.primary + ", 0)"), new Chart(o, {
			type: "lineWithShadow",
			data: {
	...
	o = document.getElementById("categoriesChart"), o && (o.getContext("2d"), new Chart(o, {
		type: "polarAreaWithShadow",
		data: {
			labels: ["Potatoes", "Tomatoes", "Onions"],
			datasets: [{
				data: [25, 10, 15],
				backgroundColor: ["rgba(" + t.primary + ", .1)", "rgba(" + t.primary + ", .5)", "rgba(" + t.primary + ", .25)"],
				borderColor: "rgba(" + t.primary + ")",
				borderWidth: 2
			}]
		},
	...
	})), o = document.getElementById("areaChart"), o && (o.getContext("2d"), new Chart(o, {
		type: "line",
		data: {
	...
	})), o = document.getElementById("areaChartWithShadow"), o && (o.getContext("2d"), new Chart(o, {
		type: "lineWithShadow",
		data: {
			labels: ["January", "February", "March", "April", "May", "June"],
			datasets: [{
	...
	})), o = document.getElementById("barChart"), o && (o.getContext("2d"), new Chart(o, {
		type: "bar",
		data: {
			labels: ["January", "February", "March", "April", "May", "June"],
			datasets: [{
	...
	})), o = document.getElementById("barChartWithShadow"), o && (o.getContext("2d"), new Chart(o, {
		type: "barWithShadow",
		data: {
			labels: ["January", "February", "March", "April", "May", "June"],
			datasets: [{
	...
	})), o = document.getElementById("lineChart"), o && (o.getContext("2d"), new Chart(o, {
		type: "line",
		data: {
			labels: ["January", "February", "March", "April", "May", "June"],
			datasets: [{
	...
	})), o = document.getElementById("lineChartWithShadow"), o && (o.getContext("2d"), new Chart(o, {
		type: "lineWithShadow",
		data: {
			labels: ["January", "February", "March", "April", "May", "June"],
			datasets: [{
	...
	})), o = document.getElementById("pieChart"), o && (o.getContext("2d"), new Chart(o, {
		type: "pie",
		data: {
			labels: ["Potatoes", "Tomatoes", "Onions"],
			datasets: [{
	...
	})), o = document.getElementById("pieChartWithShadow"), o && (o.getContext("2d"), new Chart(o, {
		type: "pieWithShadow",
		data: {
			labels: ["Potatoes", "Tomatoes", "Onions"],
			datasets: [{
	...
	})), o = document.getElementById("doughnutChart"), o && (o.getContext("2d"), new Chart(o, {
		type: "doughnut",
		data: {
			labels: ["Potatoes", "Tomatoes", "Onions"],
			datasets: [{
	...
	})), o = document.getElementById("doughnutChartWithShadow"), o && (o.getContext("2d"), new Chart(o, {
	...
	})), o = document.getElementById("radarChart"), o && (o.getContext("2d"), new Chart(o, {
		type: "radar",
		data: {
	...
	})), o = document.getElementById("radarChartWithShadow"), o && (o.getContext("2d"), new Chart(o, {
	...
	})), o = document.getElementById("polarChart"), o && (o.getContext("2d"), new Chart(o, {
		type: "polarArea",
		data: {
			labels: ["Potatoes", "Tomatoes", "Onions"],
			datasets: [{
	...
	})), o = document.getElementById("polarChartWithShadow"), o && (o.getContext("2d"), new Chart(o, {
		type: "polarAreaWithShadow",
		data: {
			labels: ["Potatoes", "Tomatoes", "Onions"],
			datasets: [{
	...
	const a = {
			afterInit: t => {
				const e = t.canvas.parentNode,
					...
					r = t.data.labels[0];
				e.querySelector(".chart-heading").innerHTML = a, e.querySelector(".chart-value").innerHTML = "$" + o, e.querySelector(".chart-label").innerHTML = r
			}
		},
		r = {
			plugins: {
	...
	o = document.getElementById("lineWithAnnotationChart1"), o && (o.getContext("2d"), new Chart(o, {
		...
		options: r
	})), o = document.getElementById("lineWithAnnotationChart2"), o && (o.getContext("2d"), new Chart(o, {
		type: "lineWithAnnotation",
		plugins: [a],
		data: {
			labels: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
		...
		options: r
	})), o = document.getElementById("lineWithAnnotationChart3"), o && (o.getContext("2d"), new Chart(o, {
		type: "lineWithAnnotation",
		plugins: [a],
		data: {
			labels: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
		...
		options: r
	})), o = document.getElementById("lineWithAnnotationChart4"), o && (o.getContext("2d"), new Chart(o, {
		type: "lineWithAnnotation",
		plugins: [a],
		data: {
			labels: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
		...
		options: r
	})), o = document.getElementById("lineWithAnnotationAndShadowChart1"), o && (o.getContext("2d"), new Chart(o, {
		...
		options: r
	})), o = document.getElementById("lineWithAnnotationAndShadowChart2"), o && (o.getContext("2d"), new Chart(o, {
		type: "lineWithAnnotationAndShadow",
		plugins: [a],
		data: {
			labels: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
		...
		options: r
	})), o = document.getElementById("lineWithAnnotationAndShadowChart3"), o && (o.getContext("2d"), new Chart(o, {
		type: "lineWithAnnotationAndShadow",
		plugins: [a],
		data: {
			labels: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
		...
		options: r
	})), o = document.getElementById("lineWithAnnotationAndShadowChart4"), o && (o.getContext("2d"), new Chart(o, {
		type: "lineWithAnnotationAndShadow",
		plugins: [a],
		data: {
			labels: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
...
const menu = () => {
	...
	o.classList.contains("menu-wide") && i(), on(".menu-bar", "click", "[data-toggle='menu-type']", e => {
		(e => {
			const a = o.querySelector(".menu-detail.open");
			switch (e) {
				case "icon-only":
					t.classList.add("menu-icon-only"), o.classList.add("menu-icon-only"), localStorage.setItem("menuType", "menu-icon-only"), o.classList.contains("menu-wide") && (n(), a && showOverlay(!0));
					break;
				case "wide":
					t.classList.add("menu-wide"), o.classList.add("menu-wide"), localStorage.setItem("menuType", "menu-wide"), t.classList.remove("menu-icon-only"), o.classList.remove("menu-icon-only"), i(), a && hideOverlay();
					break;
				case "hidden":
					t.classList.add("menu-hidden"), o.classList.add("menu-hidden"), localStorage.setItem("menuType", "menu-hidden"), r();
					break;
				default:
					t.classList.remove("menu-icon-only"), o.classList.remove("menu-icon-only"), localStorage.removeItem("menuType"), o.classList.contains("menu-wide") && (n(), a && showOverlay(!0))
			}
...
const showOverlay = t => {
	...
	ratingStars = () => {
		rateStars = t => {
			...
			let a = 0;
			a = o.length - o.indexOf(t.target), o.forEach(t => t.classList.remove("active")), t.target.classList.add("active"), console.log("You have rated " + a + " stars.")
